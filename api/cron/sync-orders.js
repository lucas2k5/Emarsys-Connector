// Vercel Cron Job para sincronização de pedidos VTEX
...
module.exports = async function handler(req, res) {
  ...
  console.log('🕐 [Vercel Cron] Iniciando sincronização de pedidos VTEX...');
  ...
  try {
    ...
    console.log(`✅ Sincronização de orders concluída em ${duration}ms`);
